...
const props = withDefaults(defineProps<CalendarRootProps & { class?: HTMLAttributes["class"], layout?: LayoutTypes, yearRange?: DateValue[], eventDates?: Set<string> }>(), {
...
provide('calendarEventDates', computed(() => props.eventDates ?? new Set<string>()))
</script>
...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-y-2 mt-2 sm:flex-row sm:gap-x-4 sm:gap-y-0">
